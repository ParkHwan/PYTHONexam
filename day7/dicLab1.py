...
"""
color_dic = {"red": "#ff0000", "blue": "#0000ff", "green": "#008000", "yellow": "#ffff00", "orange": "#ffa500"
             , "black": "#000000", "whte": "#ffffff", "violet": "#ee82ee", "pink": "#ffc0cb", "lime": "#00f00"}
color_name = input("칼라명을 영문으로 입력하세요 :")
if color_name in color_dic:
    print(color_name, "칼라의 RGB 값은", color_dic[color_name], "입니다")
else:
